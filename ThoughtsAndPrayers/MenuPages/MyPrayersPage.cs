...
namespace ThoughtsAndPrayers
{
	...
	class MyNewNativeCell : ViewCell
	{
		...
		public MyPrayersPage ()
		{
			...
			answerListView = new ListView () {
				...
				ItemTemplate = new DataTemplate (() => {
					var nativeCell = new MyNewNativeCell ();
					return nativeCell;
				})
			};
			...
			//MESSAGES
			MessagingCenter.Subscribe<MyNewNativeCell> (this, "ThoughtActionItem", ItemBought);
			MessagingCenter.Subscribe<MyNewNativeCell> (this, "PrayerActionItem", ItemQuantityIncreased);
...
//					theListView, 
		...
		//CONTEXT 3
		internal void ItemBought (MyNewNativeCell item)
		{
		...
		internal void ItemQuantityIncreased (MyNewNativeCell item)
		{
			//write something here
			DisplayAlert ("Alert", "hello", "OK");
		}
	...
	//class MyFunctionalCell : TextCell
	//{
	//	public MyFunctionalCell ()
	//	{
